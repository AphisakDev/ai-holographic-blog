...
import { A as isTableElement, C as isContainingBlock, E as isLastTraversableNode, M as isWebKit, O as isOverflowElement, S as getWindow, T as isHTMLElement, _ as getFrameElement, b as getOverflowAncestors, c as mergeProps, d as useStableCallback, f as useRefWithInit, g as getDocumentElement, h as getContainingBlock, i as NOOP, j as isTopLayer, l as useIsoLayoutEffect, m as getComputedStyle$1, n as EMPTY_ARRAY, o as useMergedRefs, r as EMPTY_OBJECT, s as useButton, t as useRenderElement, u as error, v as getNodeName, w as isElement, x as getParentNode, y as getNodeScroll } from "./useRenderElement-DhOJE8FG.js";
import { $ as getAlignmentSides, A as useDismiss, At as getTarget, B as enqueueFocus, Bt as useTimeout, C as transitionStatusMapping, Ct as none, D as Store, Dt as isTypeableCombobox, Et as getFloatingFocusElement, F as FloatingPortal, Ft as isVirtualClick, G as isIndexOutOfListBounds, Gt as useOnFirstRender, H as getMaxListIndex, Ht as jsdom, It as isVirtualPointerEvent, J as createCoords, K as isListIndexDisabled, L as DISABLED_TRANSITIONS_STYLE, Lt as stopEvent, M as FloatingFocusManager, Mt as ARROW_LEFT, N as useFloatingParentNodeId, Nt as ARROW_RIGHT, O as useStore, Ot as activeElement, P as useFloatingTree, Pt as ARROW_UP, Q as getAlignmentAxis, R as DROPDOWN_COLLISION_AVOIDANCE, Rt as useScrollLock, S as useOpenChangeComplete, St as listNavigation, T as FloatingRootStore, Tt as windowResize, U as getMinListIndex, Ut as webkit, V as findNonDisabledListIndex, Vt as ownerDocument, W as isElementVisible, Wt as addEventListener, X as floor, Y as evaluate, Z as getAlignment, _t as cancelOpen, a as inertValue, at as getPaddingObject, ct as max, d as triggerOpenStateMapping, dt as round, et as getAxisLength, f as PopupTriggerMap, ft as sides, gt as createChangeEventDetails, ht as useValueAsRef, i as InternalBackdrop, it as getOppositePlacement, j as useClick, jt as ARROW_DOWN, k as createSelector, kt as contains, l as popupStateMapping, lt as min, mt as visuallyHiddenInput, nt as getOppositeAxis, o as COMPOSITE_KEYS, ot as getSide, p as FOCUSABLE_POPUP_PROPS, pt as visuallyHidden, q as clamp$1, r as useValueChanged, rt as getOppositeAxisPlacements, s as useBaseUiId, st as getSideAxis, t as useOpenInteractionType, tt as getExpandedPlacements, u as pressableTriggerOpenStateMapping, ut as rectToClientRect, w as useTransitionStatus, xt as itemPress, yt as focusOut, z as useId, zt as useAnimationFrame } from "./useOpenInteractionType-Dttp3_9s.js";
...
var SelectArrow = /*#__PURE__*/ import_react.forwardRef(function SelectArrow(componentProps, forwardedRef) {
	...
	const element = useRenderElement("div", componentProps, {
		state: {
			open: useStore(store, selectors.open),
			side,
			align,
