...
import { r as EMPTY_OBJECT, s as useButton, t as useRenderElement } from "./useRenderElement-DhOJE8FG.js";
import { A as useDismiss, At as getTarget, C as transitionStatusMapping, E as ReactStore, F as FloatingPortal, Gt as useOnFirstRender, I as CLICK_TRIGGER_IDENTIFIER, M as FloatingFocusManager, Rt as useScrollLock, S as useOpenChangeComplete, T as FloatingRootStore, _ as useOpenStateTransitions, a as inertValue, b as usePopupStore, bt as imperativeAction, c as CommonPopupDataAttributes, d as triggerOpenStateMapping, f as PopupTriggerMap, g as useImplicitActiveTrigger, gt as createChangeEventDetails, h as setPopupOpenState, i as InternalBackdrop, j as useClick, k as createSelector, kt as contains, l as popupStateMapping, m as createDefaultInitialFocus, n as useOpenMethodTriggerProps, o as COMPOSITE_KEYS, p as FOCUSABLE_POPUP_PROPS, s as useBaseUiId, v as usePopupInteractionProps, vt as closePress, x as useTriggerDataForwarding, y as usePopupRootSync } from "./useOpenInteractionType-Dttp3_9s.js";
...
//#endregion
//#region node_modules/@base-ui/react/dialog/viewport/DialogViewportDataAttributes.mjs
...
var AlertDialogHandle = class extends DialogHandle {
	constructor(store) {
		...
		if (store) this.store.update(alertDialogState);
	}
};
/**
